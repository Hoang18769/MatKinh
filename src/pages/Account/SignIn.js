        ...
        <div className="px-6 py-4 w-full h-[90%] flex flex-col justify-center overflow-y-scroll scrollbar-thin scrollbar-thumb-primeColor">
          ...
          <div className="flex flex-col gap-3">
            ...
            <button
              ...
              class="w-full px-3 py-3 my-2 text-white bg-indigo-500 rounded-md hover:bg-indigo-600 focus:outline-none duration-100 ease-in-out"
            >
              Đăng nhập
            </button>
            <p className="text-sm my-2 text-center font-titleFont font-medium">
