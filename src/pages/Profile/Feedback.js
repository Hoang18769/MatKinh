      ...
      {prop.order_details?.map((item) => (
        <div className="border items-center">
          <div className="flex justify-center items-center px-8 py-4">
            ...
            <div className="px- w-20 text-base font-semibold  ">
            ...
            {prop.feedback.find(
              ...
              <p class="px-2 inline-flex text-sm leading-5 font-semibold rounded-full bg-yellow-100 text-yellow-600">bạn đã đánh giá rồi</p>
            ) : (
              <>
                {" "}
                <Box
