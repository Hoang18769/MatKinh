...
const ProductDetails = () => {
  ...
  const fetchData2 = async () => {
    try {
      ...
      if (feedback) {
        setRating(Math.round(feedback.reduce((a, b) => a + b.rating, 0)));
      }
    } catch (error) {
      console.error("Error fetching data:", error);
    }
  ...
  // setAvg(Math.round(sum/feedback.length));
        ...
        <div className="flex flex-col gap-4 lg:w-2/4">
          ...
          <div className="flex item-center">
            ...
            >
              <Rating
                ...
                value={
                  feedback
                    ? Math.round(feedback.reduce((a, b) => a + b.rating, 0))
                    : 0
                }
                readOnly
              />
          ...
          <div className="flex flex-row items-center gap-12">
            <button
              ...
              class="btn overflow-hidden relative w-64 bg-indigo-500 text-white py-4 px-4 rounded-md font-bold uppercase -- before:block before:absolute before:h-full before:w-full before:bg-indigo-400 before:left-0 before:top-0 before:-translate-y-full hover:before:translate-y-0 before:transition-transform"
            >
              <span class="relative">   Thêm vào giỏ hàng</span>
            </button>
          </div>
          <div
